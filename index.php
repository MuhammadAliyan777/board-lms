        ...
        <section id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                <div class="home-message">
                    ...
                    <small>You can find all important questions, numericals, model papers and solved questions.</small>
...
<div class="caro-item">
                        <div class="course-box">
                            ...
                            <a target="_blank" href = "uploaded_img/<?php echo $fetch_products['image']; ?>"><img class="img-responsive"  src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt=""></a>
                            ...
                            <div class="course-details">
                                <h4>
                                    <small><?php echo $fetch_products['category']; ?></small>
                                    <a href="#" title=""><?php echo $fetch_products['name'];  ?></a>
                                </h4>
